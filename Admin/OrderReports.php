...
$w=array(15,40,30,15,20,30,30,20,18,15,15,15,15);
	...
	{ //width
		...
		$this->Cell(30,6,$eachResult["Address"],1);
		$this->Cell(15,6,$eachResult["Country"],1);
		$this->Cell(20,6,$eachResult["City"],1);
		$this->Cell(30,6,$eachResult["Phone"],1);
...
$pdf->AddPage();
	...
	$pdf->Cell(50);
	$pdf->Write(5, 'HFND.COM Order Detail Management');
	$pdf->Ln();
	...
	$pdf->Cell(0);
	$pdf->Write(5, 'February 2020 :All Total Customer Orders : '.$count.'');
	$pdf->Ln();
