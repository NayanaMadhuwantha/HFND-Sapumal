...
?>
 ...
 <div id="tab1" class="tab_content">
  <table class="tablesorter" cellspacing="0"> 
			...
			<thead>  <th Colspan="7">  SomStore Product Data Table </th></thead>
		<thead>
			</tr>
   		      <th>Check</th> 
    	      <th>Employee_ID</th>
...
<?php
   ...
   <td><?php echo $row['Username']; ?></td>
    ...
    <td> <a href="prodViewUpdate.php?update=<?php echo $row['Employee_ID']; ?>"  onClick="edit(this);" title="empEdit" >  <input type="image" src="images/icn_edit.png" title="Edit"> </a>
     <a href="prodDelete.php?delete=<?php echo $row['Employee_ID']; ?>" onClick="del(this);" title="Delete" ><input type="image" src="images/icn_trash.png" title="Trash">  </a></td>
    </tr>
