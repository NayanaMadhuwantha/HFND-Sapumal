...
?>
                            ...
                            <p>
                                ...
                                <input id="email" name="email" placeholder="sapumalb@gmail.com" type="email" AUTOCOMPLETE=OFF />
                            </p>
                            <p>
...
?>
                           ...
                           <p>
                                ...
                                <input id="address" name="address" placeholder="Welimada Bandarawela" type="text" AUTOCOMPLETE=OFF />
                            </p>
                            <p>
		  ...
		  <option value="ZW" countrynum="263">Zimbabwe</option>
                             ...
                             <p>
                                ...
                                <input id="city" name="city" placeholder="e.g Badulla" type="text" AUTOCOMPLETE=OFF />
                            </p>														 
...
?>
                            ...
                            <p>
                                ...
                                <input id="delivery" name="delivery" placeholder="" type="date" AUTOCOMPLETE=OFF />
                            </p>
		...
		<!-- End Main -->
			...
			<div class="copy">
				...
				<div class="shell">
					...
					</div>	<p align="center">&copy; HFND.COM. Groups <a href="index.php"><i><font color="fefefe"> Welcome To <strong> HFND.COM</strong> Online Shopping Site </font></i></a></p>
					<div class="cl">&nbsp;</div>
				</div>
				<!-- End Shell -->
			</div>
