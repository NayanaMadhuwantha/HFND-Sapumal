...
<!-- Begin Sidebar -->
   ...
   <input name="shout_message" id="shout_message" type="text" placeholder="Type Message Hit Enter" maxlength="100" /> 
					...
					</div>	<p align="center">&copy; HFND.COM. <a href="index.php"><i><font color="fefefe"> Welcome To <strong>HFND.COM</strong> Online Shopping Site </font></i></a></p>
					<div class="cl">&nbsp;</div>
				</div>
				<!-- End Shell -->
			</div>
