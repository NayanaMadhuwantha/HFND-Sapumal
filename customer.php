...
<div id="form_wrapper" class="form_wrapper">
   ...
   <tr>
    <td>  
		...
		<input type="text" input id="textEmail" name="email" id="email"/>
    ...
    <td>  
		...
		<label>Password: <input id="password1" title="Password must contain at least 6 characters, including UPPER/lowercase and numbers." type="password" required pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{6,}" name="pwd1"></label>
   ...
   <td>   
     	  <label>Username: <input id="field_username"  type="text"  name="username"></label>
   ...
   <tr>
    <td>  
		...
		<label> Confirm Password: <input id="password2" title="Please enter the same Password as above." type="password" required pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{6,}" name="pwd2">
		</label>
	</td>
...
<p><input type="submit" value="Submit"button type="button" onclick="myFunction()"></p>
</form>
    	 				...
    	 				<h2>Find Us Here</h2>
					    	  <div class="map">
							   	    <iframe width="100%" height="175" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"
										<img src="images/Opera Snapshot_2020-06-19_114932_www.google.com.png"></iframe><br><small><a href="https://www.google.com/maps/place/Pansilu+Ayurvedic+Treatment+Center+Bandarawela+(SPA)/@6.8372879,80.9879773,15z/data=!4m5!3m4!1s0x0:0xeb86173e879a20ca!8m2!3d6.8372879!4d80.9879773" style="color:#666;text-align:left;font-size:12px">View Larger Map</a></small>
							 </div>
      				</div>
      			<div class="company_address">
				     	<h2>Company Information :</h2>
						    	<p><big> HFND.COM</big> Is A Online Sales System Company Established In BANDARAWELA</p>
						   		<p>  </p>
								<p> NO 12</p>
						   		<p>BADULLA ROAD</p>
								<p>BANDARAWELA</p>
								 <BIG>PHONE</BIG>
								   ...
								   <p>0766462180</p>
				   		          <BIG>EMAIL</BIG>
				 	 	          <p>ASBANDARA@gmail.com</p>
								  <p>ANUTHTHARASAPUMAL30@gmail.com</p>
								  <p>ANUSAPUMAL8@gmail.com</p>
								   <BIG>FOLLOW US</BIG>
