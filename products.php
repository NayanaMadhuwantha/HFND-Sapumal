		...
		<div id="footer">
			...
			<div class="copy">
				...
				<div class="shell">
					...
					<div class="cl">&nbsp;</div>
					Copyright © 2020 HFND.COM  you can do online shopping confidently and conviently with us.we ensure your financial security and privacy. any of your informations sent to us would never be sent to any other third party. 
				</div>
				<!-- End Shell -->
			</div>
		</div>
