...
<body>
	...
	<div id="wrapper">
		...
		<div id="header">
			<!-- Begin Shell -->
			<div class="shell">
				<h1 id="logo"><a class="notext" href="#" title="Somstore">HFND.COM</a></h1>
				<div id="top-nav">
					<ul>
...
<div class="viewcart">
	...
	if(isset($_SESSION["cart_session"]))
    {
		...
		echo '<spa class="midigta"><a  class="a-btn" href="Somstore checkout/zaadprocess.php"><span class="a-btn-text">Proced On DEBIT CARD</span> </a></span>';
		
		echo '<span class="midigta"> <a  class="a-btn" href="Somstore checkout/process.php"> <span class="a-btn-text"> Pay On VISA</span></a></span>';
		echo '</span>';
		echo '</form>'; 
    ...
    ?>
			...
			<div id="content">
				<div class="post">
					...
					you can do online shopping confidently and conviently with us.we ensure your financial security and privacy. any of your informations sent to us would never be sent to any other third party. <a href="#" class="more" title="Read More">Read More</a></p>
					<div class="cl">&nbsp;</div>
				</div>
			</div>
			<!-- End Content -->
